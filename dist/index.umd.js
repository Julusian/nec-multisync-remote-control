(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('net-socket'), require('timers')) :
  typeof define === 'function' && define.amd ? define(['exports', 'net-socket', 'timers'], factory) :
  (factory((global.nec-p401 = global.nec-p401 || {}),global.net,global.timers));
}(this, (function (exports,net,timers) { 'use strict';
...
var NecControl = function () {
  ...
  NecControl.prototype.connect = function connect() {
    ...
    if (this.timeoutInterval) timers.clearInterval(this.timeoutInterval);
    ...
    this.timeoutInterval = timers.setInterval(function () {
  ...
  NecControl.prototype._receivedMessage = function _receivedMessage(message) {
    ...
    this.receiveTimeout = timers.setTimeout(function () {
