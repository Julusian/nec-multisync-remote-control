...
module.exports.get = function(id, command){
  ...
  var primary = buildHeader(id, Type.GET, body.length/2) + body;
...
module.exports.set = function(id, command, value){
  ...
  var primary = buildHeader(id, Type.SET, body.length/2) + body;
...
module.exports.getCommand = function(id, command){
  var encodedCommand;
  switch(command){
    case "SERIAL":
...
module.exports.setCommand = function(id, command, data){
  var encodedCommand;
  switch(command){
    case "POWER":
      ...
      encodedCommand = encodeHex("01D6") + encodeHex(powerMode);
    break;
    default:
      return null;
  }
