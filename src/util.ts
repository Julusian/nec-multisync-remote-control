export function encodeToHexBytes(value: number, padLength?: number): number[] {
...
export function bufferWriteHex(buffer: Buffer, value: number, offset: number, length: number): void {
